...
public class OwnerUseCase implements IOwnerServicePort {
    ...
    public OwnerUseCase(IUserPersistencePort userPersistencePort,IPasswordEncodedServicePort passwordEncodedServicePort, IRolePersistencePort rolePersistencePort) {
